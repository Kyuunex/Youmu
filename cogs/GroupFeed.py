    ...
    async def groupfeed_background_loop(self):
        ...
        while not self.bot.is_closed():
            try:
                ...
                # await check_group(channel_list, "28")
                # await asyncio.sleep(5)
                # await check_group(channel_list, "32")
                # await asyncio.sleep(120)
                # await check_group(channel_list, "4")
                # await asyncio.sleep(120)
                # await check_group(channel_list, "11")
                # await asyncio.sleep(120)
                # await check_group(channel_list, "16")
                # await asyncio.sleep(120)
                # await check_group(channel_list, "22")
